...
void main() {
  group('ProjectDetectionService', () {
    test('decodes a file:// workspace uri from Cursor/VSCode storage json', () {
      const json =
          '{"folder": "file:///Users/me/projects/my-app"}';
    ...
    test('handles url-encoded spaces in the workspace path', () {
      ...
      expect(ProjectDetectionService.pathFromWorkspaceJson(json),
          '/Users/me/My App');
    });

    test('returns null for storage json with no folder', () {
      expect(ProjectDetectionService.pathFromWorkspaceJson('{"other": 1}'),
          isNull);
    ...
    test('scanForClaudeProjects finds dirs containing a .claude folder',
        () async {
    ...
    test('scan respects the timeout and returns what it found so far',
        () async {
